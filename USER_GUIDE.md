# RedNote Sync for Obsidian 使用指南

![RedNote to Obsidian](rednote2obsidian.png)

同步小红书（个人帖子、收藏、点赞）到 Obsidian Vault。
...
下载插件安装包：[rednote2obsidian.zip](https://static.2notion.com/rednote2notion/rednote2obsidian.zip)
...
| 专辑白名单 | 仅在「同步专辑」打开时显示。点击「刷新专辑列表」拉取当前账号的全部专辑，勾选要同步的子集；不勾选任何一个 = 同步全部专辑 | 不筛选 |
| 下载视频到本地 | 开启后帖子视频会随图片一并下载到本地（小红书视频通常 5–50MB/条），占用较多磁盘空间；关闭则仅嵌入远程视频链接（链接可能失效） | 关闭 |
...
<details>
<summary><strong>Q：同步时提示"登录已过期"？</strong></summary>
...
<details>
<summary><strong>Q：图片显示不出来？</strong></summary>
...
<details>
<summary><strong>Q：想重新同步所有数据？</strong></summary>
...
<details>
<summary><strong>Q：切换了小红书账号怎么办？</strong></summary>
...
<details>
<summary><strong>Q：同步间隔设多少合适？</strong></summary>
...
<details>
<summary><strong>Q：改了「每批同步数量」或「同步间隔」好像没生效？</strong></summary>
...
<details>
<summary><strong>Q：怎么只同步一部分专辑？</strong></summary>
...
<details>
<summary><strong>Q：视频文件能下载到本地吗？</strong></summary>
...
<details>
<summary><strong>Q：如何更新插件？</strong></summary>
...
插件提供 **免费体验 10 篇**，达到限额后需要在设置页填入授权码继续同步。
...
<details>
<summary><strong>🛡️ 隐私保护声明（Privacy Policy）</strong></summary>
...
<details>
<summary><strong>⚠️ 使用免责声明（Disclaimer）</strong></summary>
...
https://blog.notionedu.com/1b373415a27980b1b249eab49061527f
